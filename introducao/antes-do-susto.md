...
Então fui procurar material na internet. Procurei sobre automatização de tarefa e fui no site do [grunt.js](http://gruntjs.com/). O link *“Getting Started”* é onde devemos clicar para aprender algo, não é mesmo? A primeira linha, do primeiro parágrafo, na primeira página que abro, diz o seguinte:

*“Grunt and Grunt plugins are installed and managed via npm, the Node.js package manager.”*

Mas whata? npm? node.js? Ok. Tinha que correr atras do prejuízo. Achei que fosse mais fácil se tivesse visto como isso funciona na prática. Googlei novamente e abri um site famoso em português que dizia: 
